    ...
    try {
      ...
      async function first_layer(){
        ...
        collector.on('collect', menu => {
          ...
          else menu?.reply({content: `<:Falsch:947228552267464765> You are not allowed to do that! Only: <@${cmduser.id}>`, ephemeral: true});
        });
                  ...
                  if (channel) {
                    try {
                      ...
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<a:Richtig:947229061489492109> I will now send all detected Ghost Pings in \`${channel.name}\``)
                        .setColor(es.color)
