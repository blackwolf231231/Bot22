  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(user) {
        ...
        let button_public_invite = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.public)).setURL("https://discord.com/oauth2/authorize?client_id=927694439407841290&permissions=4294967287&scope=bot+applications.commands")
        let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://discord.gg/aaJRAbfdu5")
        ...
        message.reply({ 
          embeds: [new MessageEmbed()
            ...
            .setFooter(client.getFooter(`${user.username} | powered by 𐌱Ľ𐌻⊂𐌺ʷᵒˡᶠ#2252`, "https://imgur.com/jPItIw0.gif"))],
